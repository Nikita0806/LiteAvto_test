...
class TestQuestionnaire(BaseTest):
    ...
    def test_offer_a_car(self):
        ...
        self.offer_page.scrol_down()
        self.offer_page.photo_1('https://github.com/Nikita0806/LiteAvto_test/blob/ff7487a2388abf89d1edda5c83e1a6c0417b384f/photo/1.TEyKera44KW8zWKonhNlDobY4qM022KzvNbipzrT6K88.webp')
        self.offer_page.photo_2('https://github.com/Nikita0806/LiteAvto_test/blob/ff7487a2388abf89d1edda5c83e1a6c0417b384f/photo/1.qdHoOLa4BTjej4c1thrrkuSaBz5WmYcu3pQHOliRDTJe.webp')
        self.offer_page.photo_3('https://github.com/Nikita0806/LiteAvto_test/blob/ff7487a2388abf89d1edda5c83e1a6c0417b384f/photo/1.fcIFDra40SszpxMuc083gQms0y27r1Mjc6rTKbWn2SGz.webp')
